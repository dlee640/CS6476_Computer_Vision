...
def calculate_num_ransac_iterations(prob_success: float,
    ...
    ############################################################################
    # TODO: YOUR CODE HERE
    num_iterations = np.log(1-prob_success)/np.log(1-ind_prob_correct**sample_size)
    ############################################################################
...
def ransac_projection_matrix(pts2d: np.ndarray,
    ...
    for _ in range(num_iterations):
        ...
        # TODO: YOUR CODE HERE
        if i is 0:
            best_P = estimate_camera_matrix_dlt(sampled_pts2d, sampled_pts3d)
        else:
            P = estimate_camera_matrix(sampled_pts2d, sampled_pts3d, P_initial)
